...
* fix: null access_tier on FileStorage shares so Azure stops rejecting them (#28) @jorrite

**Full Changelog**: https://github.com/schubergphilis/terraform-azure-mcaf-storage-account/compare/v0.11.0...v0.11.1
...
* feat: add provisioned v2 file share support (#26) @frank-m

**Full Changelog**: https://github.com/schubergphilis/terraform-azure-mcaf-storage-account/compare/v0.10.0...v0.11.0
