...
| <a name="input_cmk_key"></a> [cmk\_key](#input\_cmk\_key) | Customer Managed Key to use for this storage account. Leave null to not attach a CMK. | <pre>object({<br/>    key_vault_key_id = string<br/>  })</pre> | `null` | no |
